...
func (cu *CommentUpdate) SetDeleteFlag(b bool) *CommentUpdate {
	cu.mutation.SetDeleteFlag(b)
	return cu
}

// SetNillableDeleteFlag sets the "delete_flag" field if the given value is not nil.
func (cu *CommentUpdate) SetNillableDeleteFlag(b *bool) *CommentUpdate {
	if b != nil {
		cu.SetDeleteFlag(*b)
	}
	return cu
...
func (cu *CommentUpdate) SetFoodID(u uint64) *CommentUpdate {
	cu.mutation.ResetFoodID()
	cu.mutation.SetFoodID(u)
	return cu
}

// AddFoodID adds u to the "food_id" field.
func (cu *CommentUpdate) AddFoodID(u uint64) *CommentUpdate {
	cu.mutation.AddFoodID(u)
	return cu
}
...
func (cu *CommentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.DeleteFlag(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeBool,
			Value:  value,
			Column: comment.FieldDeleteFlag,
		})
	}
	...
	if value, ok := cu.mutation.FoodID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUint64,
			Value:  value,
			Column: comment.FieldFoodID,
		})
	}
	if value, ok := cu.mutation.AddedFoodID(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeUint64,
			Value:  value,
			Column: comment.FieldFoodID,
...
// SetDeleteFlag sets the "delete_flag" field.
func (cuo *CommentUpdateOne) SetDeleteFlag(b bool) *CommentUpdateOne {
	cuo.mutation.SetDeleteFlag(b)
	return cuo
}

// SetNillableDeleteFlag sets the "delete_flag" field if the given value is not nil.
func (cuo *CommentUpdateOne) SetNillableDeleteFlag(b *bool) *CommentUpdateOne {
	if b != nil {
		cuo.SetDeleteFlag(*b)
	}
	return cuo
...
// SetFoodID sets the "food_id" field.
func (cuo *CommentUpdateOne) SetFoodID(u uint64) *CommentUpdateOne {
	cuo.mutation.ResetFoodID()
	cuo.mutation.SetFoodID(u)
	return cuo
}

// AddFoodID adds u to the "food_id" field.
func (cuo *CommentUpdateOne) AddFoodID(u uint64) *CommentUpdateOne {
	cuo.mutation.AddFoodID(u)
	return cuo
}
...
func (cuo *CommentUpdateOne) sqlSave(ctx context.Context) (_node *Comment, err error) {
	...
	if value, ok := cuo.mutation.DeleteFlag(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeBool,
			Value:  value,
			Column: comment.FieldDeleteFlag,
	...
	if value, ok := cuo.mutation.FoodID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUint64,
			Value:  value,
			Column: comment.FieldFoodID,
	...
	if value, ok := cuo.mutation.AddedFoodID(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeUint64,
			Value:  value,
			Column: comment.FieldFoodID,
