...
func (cc *CommentCreate) SetDeleteFlag(b bool) *CommentCreate {
	cc.mutation.SetDeleteFlag(b)
	return cc
}

// SetNillableDeleteFlag sets the "delete_flag" field if the given value is not nil.
func (cc *CommentCreate) SetNillableDeleteFlag(b *bool) *CommentCreate {
	if b != nil {
		cc.SetDeleteFlag(*b)
	}
	return cc
...
func (cc *CommentCreate) SetFoodID(u uint64) *CommentCreate {
	cc.mutation.SetFoodID(u)
	return cc
}
...
func (cc *CommentCreate) defaults() {
	...
	if _, ok := cc.mutation.DeleteFlag(); !ok {
		v := comment.DefaultDeleteFlag
		cc.mutation.SetDeleteFlag(v)
	}
}
...
func (cc *CommentCreate) createSpec() (*Comment, *sqlgraph.CreateSpec) {
	...
	if value, ok := cc.mutation.DeleteFlag(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeBool,
			Value:  value,
	...
	if value, ok := cc.mutation.FoodID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint64,
			Value:  value,
