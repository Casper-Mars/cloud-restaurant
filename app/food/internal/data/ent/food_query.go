...
// Returns a *NotSingularError when exactly one Food entity is not found.
...
func (fs *FoodSelect) Scan(ctx context.Context, v interface{}) error {
	...
	fs.sql = fs.FoodQuery.sqlQuery(ctx)
